function deltaFF = lsExplorer_Compute_dFF(timeseries,stackfrequency,windowsize,basepercent,uselowpass)
%deltaFF = lsExplorer_Compute_dFF(timeseries,stackfrequency,windowsize,basepercent,uselowpass)
...
%--------------Cui Edit----------
if windowStacks>nStacks
    windowStacks=nStacks;
end
%--------------Cui Edit End-------
